...
<head>
    ...
    <script src="SecondTest.js" defer crossorigin="anonymous"> </script> <!-- defer - запуск скрипта после загрузки html страницы -->
</head>
<body>
...
<div id="main-expert" class="main container-fluid">
    <div id="expert-button" class="main-content container">
        <div class="row" id="super">
            ...
            <div class="col">
                <form name="form1">
                    <h4>В данном тесте вам необходимо нажимать "ПРОБЕЛ", когда 3 движущихся кружка одновременно будут попадать в зеленую и желтые зоны</h4>
