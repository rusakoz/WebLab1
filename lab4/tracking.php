        ...
        <div class="row" id="super">
            ...
            <div class="col">
                <form name="form1">
                    ...
                    <h4>В данном тесте вам необходимо как можно быстрее вернуть круг в исходную точку</h4>
                    <h4>ИНСТРУКЦИЯ: Чтобы перетащить круг необходимо навести на него курсор и нажать ЛКМ, после перемещения необходимо еще раз нажать ЛКМ</h4>
